    ...
    $scope.toggleDemo = function() {
      ...
      if($scope.show_demo) {
        $window.loading_screen = $window.pleaseWait({
          ...
          backgroundColor: '#f46d3b',
          loadingHtml: "<p class='loading-message'></p><div class='sk-spinner sk-spinner-double-bounce'><div class='sk-double-bounce1'></div><div class='sk-double-bounce2'></div></div>"
        });
      } else {
